...
function Init()
{
	...
	if( str == '' ){
		...
		var i = 0;
		for(i=0;i<143;i++){
			window.document.getElementById('mazefield'+i).innerHTML = '<img style="display: block;" src="images/castle/' + str.substr(i*2,1) + 'maze25.gif" width="25" height="25">';
		}
	}
}
...
{
	obj.innerHTML = '<img style="display: block;" src="images/castle/' + g_currLetter + 'maze25.gif" width="25" height="25">';
	var str = window.document.mazevalues.maze.value;
