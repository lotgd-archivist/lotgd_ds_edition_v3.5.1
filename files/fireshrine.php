...
if ($_GET['op']=="")
{
	...
	{
		if($session['user']['exchangequest']==12)
		{
...
//(Kommentar am Lagerfeuer auf dem Dorfplatz:)
...
elseif ($_GET['op']=="fireshrine")
{
	...
	switch(e_rand(1,3)){
		...
		case 2 :
			...
			addnews("`%".$session['user']['name']."`^ hat sich auf dem Stadtfest ins Lagerfeuer gestürzt und ist verbrannt!");
        CQuest::died();
      ...
      debuglog("hat das Mal des Feuers erlangt.");
			$Char->setBit(CHOSEN_FIRE,'marks', 1);
