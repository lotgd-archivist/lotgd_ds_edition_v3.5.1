...
//		return true;
//	}
//	$str_parameter = db_real_escape_string($str_parameter);
...
$access_control->su_check(access_control::SU_RIGHT_EDITORTITLES,true);
...
function get_decoded_titles()
{
	...
	$arr_title_array = utf8_unserialize(getsetting('title_array',null));
...
switch ($_GET['op'])
{
	...
	$str_titles = mixed_check_parameter($_POST['list_of_titles'], true, true, true);
	...
	else
	{
		...
		foreach($arr_titles as $str_title_line)
		{
			...
			$arr_title_array_new[] = utf8_preg_split('/\s*,\s*/',$str_title_line);
		}
		//utf8_serialize this multidimensional array
		$str_save_to_db = utf8_serialize($arr_title_array_new);
