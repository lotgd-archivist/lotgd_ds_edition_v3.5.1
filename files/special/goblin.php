...
if ($_GET['op']==''){
	...
	addnav('m?Nimm ein Getränk (100Gold)','forest.php?op=drink');
	addnav('I?Ich gehe lieber wieder ...','forest.php?op=goback');
	$session['user']['specialinc'] = 'goblin.php';
...
//		addnav('Schnell weg hier','forest.php');
		...
		switch(e_rand(1,6)){
			...
			addnews('`q'.$session['user']['name'].'`Q vertraute einem Goblin.`0');
			killplayer(100,0,0,'news.php','Na toll...');
			break;
		}
