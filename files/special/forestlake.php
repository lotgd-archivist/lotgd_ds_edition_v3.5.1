...
if ($row['charisma']==4294967295 && $row['marriedto']!=$session['user']['acctid'])
{
	$loverID=0;
}
...
function lakenav()
{
	global $session,$loverHorseID,$lovedHorseID,$allowtovillage;
	...
	if (mb_strpos($session['user']['specialmisc'],'_village'))
	{
		addnav('Zurück in die Stadt','forest.php?op=return');
	}
	else
	{
