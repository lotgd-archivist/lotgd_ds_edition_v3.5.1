		...
		case 'furniture':
			...
			switch (e_rand(1,5))
			{
				...
				case 3:
					...
					{
						output("`2Du fragst dich, warum dieses hässliche Bild im Haus hängt. ");
					}
					elseif ($session['user']['charm']>=10 and $session['user']['charm']<50)
					{
						output("`2Naja, wer auch immer dieses Bild gemalt hat, hat Talent, sollte aber noch etwas üben. ");
					}
					else
					{
						output("`2Das ist ein wirklich tolles Bild von ".($session['user']['sex']?"einer Frau":"einem Mann")."! ");
					}
					break;
				case 4:
			...
			output('`n`n`0Wenn man Charme in Zahlen ausdrücken würde, würdest du eine '.$session['user']['charm'].' haben. '.($session['user']['charm']>250?'Ist das nicht toll?':'Aber was sind schon Zahlen...').'`n');
