	...
	switch ( $item_hook ) {
		...
		case 'furniture':
			...
			elseif ($_GET['act']=="schmuckgeben"){
				...
				output("`&Dein Schmuckkästchen fasst maximal `^25`& Edelsteine. Es befinden sich bereits `@".$item['hvalue']."`& Edelsteine darin. Folglich kannst du noch `#".$space."`& Edelsteine hinein tun.`n`nWieviele möchtest du sicher verstauen?`n`n");
