...
if($_GET['op'] == 'rel_get') {
	...
	// Meldung ausgeben		
	output('`3Als du, immer noch geschwächt von deiner letzten Heldentat, auf den Marktplatz
			...
			.create_lnk('Klingt phantastisch!','marketevents.php?op=rel_get',true,true).'`n`n'
			.create_lnk('Naja.. beim nächsten Mal vielleicht..','marketevents.php?op=rel_leave',true,true) , true );
